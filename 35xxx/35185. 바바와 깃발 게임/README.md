...
<p>나나는 $1\times N$ 게임판 위에서 진행되는 게임을 하고 있다. 게임판 위에는 한 마리의 바바와 하나의 깃발이 놓여져 있다. 바바와 깃발은 서로 다른 위치에 놓여 있다.</p>
...
## 입력 
 ...
 <p>첫 번째 줄에, 게임판의 크기인 $N$과 나나가 입력한 명령어의 개수인 $L$이 공백을 사이에 두고 주어진다.</p>
...
<p>게임판이 존재한다면 <code>WIN</code>를 출력하고, 이어지는 줄에 바바의 위치 $B$와 깃발의 위치 $F$를 출력한다.</p>
